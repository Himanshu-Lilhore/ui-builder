...
export default function TailwindCode({ code, visible }) {
    ...
    return (
        <div
            className={`${visible ? "opacity-100 z-[100]" : "opacity-0 -z-10"} absolute top-0 left-0 h-full w-full max-w-[96%] max-h-[97.5%] rounded-[0.8vw] mx-[1.5vw] my-[0.2vw] border bg-zinc-800/85 shadow-inner shadow-white backdrop-blur-md overflow-hidden transition-all duration-400`}
        >
            <button
