...
export default function TailwindCode({ code, visible }) {
    ...
    return (
        <div
            className={`${visible ? "opacity-100 max-w-[96%] max-h-[97.5%]" : "opacity-10 max-w-0 max-h-0"} absolute top-0 left-0 z-[100] h-full w-full rounded-[0.8vw] mx-[1.5vw] my-[0.2vw] border bg-zinc-800/85 shadow-inner shadow-white backdrop-blur-md overflow-hidden transition-all duration-400`}
        >
            <button
